...
if [[ $2 == "clean" ]]; then
	echo "Cleaning up the build directory '../Build/LS1043aBoard/'.."
	rm -rf ../Build/LS1043aBoard/*
	exit
else
	if [[ $2 == "" ]]; then
...
build -p $WORKSPACE/LS1043aBoardPkg/LS1043aBoardPkg.dsc -a $ARCH -t $TARGET_TOOLS -b $1
