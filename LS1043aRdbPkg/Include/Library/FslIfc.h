...
#define FSL_IFC_NAND_BUF_BASE	0x70000000
...
#define FSL_IFC_NOR_FTIM0	        (FTIM0_NOR_TACSE(0x1) | \
				 FTIM0_NOR_TEADC(0x1) | \
				 FTIM0_NOR_TAVDS(0x0) | \
				 FTIM0_NOR_TEAHC(0xc))
#define FSL_IFC_NOR_FTIM1	        (FTIM1_NOR_TACO(0x1c) | \
			 	 FTIM1_NOR_TRAD_NOR(0xb) |\
				 FTIM1_NOR_TSEQRAD_NOR(0x9))
#define FSL_IFC_NOR_FTIM2	        (FTIM2_NOR_TCS(0x1) | \
				 FTIM2_NOR_TCH(0x4) | \
				 FTIM2_NOR_TWPH(0x8) | \
				 FTIM2_NOR_TWP(0x10))
...
#define FSL_IFC_CPLD_FTIM0		(FTIM0_GPCM_TACSE(0xf) | \
				FTIM0_GPCM_TEADC(0xf) | \
				FTIM0_GPCM_TEAHC(0xf))
#define FSL_IFC_CPLD_FTIM1		(FTIM1_GPCM_TACO(0xff) | \
				FTIM1_GPCM_TRAD(0x3f))
#define FSL_IFC_CPLD_FTIM2		(FTIM2_GPCM_TCS(0xf) | \
				FTIM2_GPCM_TCH(0xf) | \
				FTIM2_GPCM_TWP(0xff))
