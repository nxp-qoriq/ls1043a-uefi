  ...
  )
{
  ...
  MmioWriteBe32((UINTN)&Regs->Lut[LutBase], OPRND_0(CMD_WREN) |
         PAD_0(LUT_PAD_1) | INSTR_0(LUT_CMD));
  MmioWriteBe32((UINTN)&Regs->Lut[LutBase + 1], 0);
  MmioWriteBe32((UINTN)&Regs->Lut[LutBase + 2], 0);
  MmioWriteBe32((UINTN)&Regs->Lut[LutBase + 3], 0);

  /* Fast Read */
  LutBase = SEQ_ID_FAST_READ * 4;
  if (QSPI_FLASH_SIZE  <= SIZE_16MB)
    MmioWriteBe32((UINTN)&Regs->Lut[LutBase],
    ...
    MmioWriteBe32((UINTN)&Regs->Lut[LutBase],
                     ...
                     INSTR_1(LUT_ADDR));
  MmioWriteBe32((UINTN)&Regs->Lut[LutBase + 1],
  ...
  MmioWriteBe32((UINTN)&Regs->Lut[LutBase], OPRND_0(CMD_RDSR) |
  ...
  MmioWriteBe32((UINTN)&Regs->Lut[LutBase], OPRND_0(CMD_RDID) |
  ...
  MmioWriteBe32((UINTN)&Regs->Lut[LutBase], OPRND_0(CMD_BE_4K) |
